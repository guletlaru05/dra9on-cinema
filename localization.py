...
UI = {
    ...
    'AI로 세계관을 실사화하는 크리에이터. FALL 707: REBOOT와 오리지널 AI 영화 제작.': 'Independent AI filmmaker bringing imagined worlds to life. Creator of FALL 707: REBOOT and original AI films.',
    'AI로 세계관을 실사화하는 크리에이터.': 'Bringing imagined worlds to life through AI film.',
    'DRA9ON CINEMA는 AI로 세계관을 실사화하는 크리에이터입니다. 밀리터리 판타지 오컬트 스릴러 〈FALL 707: REBOOT〉를 비롯해, 장르 영화의 새로운 가능성을 실험합니다.': 'DRA9ON CINEMA brings imagined worlds to life through AI filmmaking. From the military fantasy and occult thriller FALL 707: REBOOT to original genre films, each project explores a new cinematic possibility.',
    ...
    '두 시대가 충돌하는, DRA9ON CINEMA의 오리지널 시리즈.': 'Two eras collide in an original series by DRA9ON CINEMA.',
