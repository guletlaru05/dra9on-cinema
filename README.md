...
FALL 707: REBOOT와 오리지널 AI 영화를 소개하는 한국어·영어 포트폴리오입니다. 공식 YouTube 영상 21편을 임베드합니다.
...
`dist/`는 빌드 결과이며 직접 수정하거나 커밋하지 않습니다. 공식 채널 콘텐츠의 2026-09-18 스냅샷이며 새 영상은 자동으로 추가되지 않습니다. 새 영상을 추가할 때 데이터·공식 썸네일·영어 번역을 함께 갱신하세요. 영상 자막·더빙을 생성하지 않으며 자막 선택은 YouTube에서 제공하는 범위에 따릅니다.
